...
<div class="vbo-params-container">
	...
	<div class="vbo-param-container">
		...
		<div class="vbo-param-setting">
			...
			echo VikBooking::getVboApplication()->printYesNoButtons('rss_optin_status', JText::translate('VBYES'), JText::translate('VBNO'), $cur_opt_in_status, 1, 0, 'rssOptinValueChanged(this.checked);');
			?>
		</div>
	</div>
	...
	<div class="vbo-param-container rss-child-setting" style="<?php echo $config['optin'] ? '' : 'display:none;'; ?>">
		...
		<div class="vbo-param-setting">
			<?php
			echo VikBooking::getVboApplication()->printYesNoButtons('rss_display_dashboard', JText::translate('VBYES'), JText::translate('VBNO'), (isset($config) && isset($config['dashboard']) ? (int)$config['dashboard'] : 0), 1, 0);
			?>
		</div>
	</div>
...
if (VikBookingLicense::isPro())
{
	...
	<div class="vbo-param-container rss-child-setting" style="<?php echo $config['optin'] ? '' : 'display:none;'; ?>">
		...
		<div class="vbo-param-setting">
			<?php
			echo VikBooking::getVboApplication()->printYesNoButtons('rss_channel_' . md5($url), JText::translate('VBYES'), JText::translate('VBNO'), (int)$checked, 1, 0, 'rssChannelValueChanged(this.checked, \'' . $url . '\');');
