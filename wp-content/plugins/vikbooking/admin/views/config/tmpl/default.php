	...
	<form name="adminForm" id="adminForm" action="index.php" method="post" enctype="multipart/form-data">
		...
		<div class="vbo-config-tabs-wrap">
			<dl class="tabs" id="tab_group_id">
				...
				<dt class="tabs <?php echo $this->curtabid == 6 ? 'open' : 'closed'; ?>" data-ptid="6" style="cursor: pointer;">
					<span>
						<h3>
				...
				<dt class="tabs <?php echo $this->curtabid == 7 ? 'open' : 'closed'; ?>" data-ptid="7" style="cursor: pointer;">
					<span>
						<h3>
