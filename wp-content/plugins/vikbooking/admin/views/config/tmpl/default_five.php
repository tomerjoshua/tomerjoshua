	...
	<div class="vbo-params-wrap">
		...
		<div class="vbo-params-container">
			...
			<div class="vbo-param-container">
				...
				<div class="vbo-param-setting"><input type="text" name="smsadminphone" size="20" value="<?php echo JHtml::_('esc_attr', VikBooking::getSMSAdminPhone()); ?>" /></div>
			</div>
			<div class="vbo-param-container">
				<div class="vbo-param-label"><?php echo JText::translate('VBCONFIGSMSPARAMETERS'); ?></div>
				<div class="vbo-param-setting"><div id="vbo-sms-params"><?php echo !empty($current_smsapi) ? VikBooking::displaySMSParameters($current_smsapi, VikBooking::getSMSParams(false)) : ''; ?></div></div>
			</div>
	<?php
	if (!empty($current_smsapi)) {
		...
		if (method_exists('VikSmsApi', 'estimate')) {
			...
			<div class="vbo-param-container">
				...
				<div class="vbo-param-setting"><button type="button" class="btn vbo-config-btn" onclick="vboEstimateCredit();"><i class="vboicn-coin-euro"></i><?php echo JText::translate('VBCONFIGSMSESTCREDIT'); ?></button><div id="vbo-sms-balance"></div></div>
			</div>
			<?php
		}
	}
