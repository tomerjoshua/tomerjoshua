...
jQuery(document).ready(function() {
	jQuery('#share_with_sel, #categories_sel').select2();
						...
						<div class="vbo-param-container">
							...
							<div class="vbo-param-setting">
								<div class="vbo-param-setting-group">
									...
									<div onclick="vbPlusMinus('fromadult', 'plus');" class="vbplusminus"><?php VikBookingIcons::e('far fa-plus-square'); ?></div>
									<div onclick="vbPlusMinus('fromadult', 'minus');" class="vbminus vbplusminus"><?php VikBookingIcons::e('far fa-minus-square'); ?></div>
								</div>
								<div class="vbo-param-setting-group">
									<div class="vbplusminuscont">
									...
									<div onclick="vbPlusMinus('toadult', 'plus');" class="vbplusminus"><?php VikBookingIcons::e('far fa-plus-square'); ?></div>
									<div onclick="vbPlusMinus('toadult', 'minus');" class="vbminus vbplusminus"><?php VikBookingIcons::e('far fa-minus-square'); ?></div>
								</div>
							</div>
						</div>
					<?php
						...
						<div class="vbo-param-container">
							...
							<div class="vbo-param-setting">
								<div class="vbo-param-setting-group">
									...
									<div onclick="vbPlusMinus('fromchild', 'plus');" class="vbplusminus"><?php VikBookingIcons::e('far fa-plus-square'); ?></div>
									<div onclick="vbPlusMinus('fromchild', 'minus');" class="vbminus vbplusminus"><?php VikBookingIcons::e('far fa-minus-square'); ?></div>
								</div>
								<div class="vbo-param-setting-group">
									<div class="vbplusminuscont">
										<span><?php echo JText::translate('VBNEWROOMMAX'); ?></span>
									...
									<div onclick="vbPlusMinus('tochild', 'plus');" class="vbplusminus"><?php VikBookingIcons::e('far fa-plus-square'); ?></div>
									<div onclick="vbPlusMinus('tochild', 'minus');" class="vbminus vbplusminus"><?php VikBookingIcons::e('far fa-minus-square'); ?></div>
								</div>
							</div>
						</div>
						<div class="vbo-param-container">
						...
						<div class="vbo-param-container">
							...
							<div class="vbo-param-setting">
								...
								<div class="vbo-param-setting-block">
									...
									<span id="resizeselmore" style="display: none;"><span><?php echo JText::translate('VBNEWOPTTEN'); ?></span><input type="text" name="resizetomore" value="600" size="3" class="vbo-small-input"/> px</span>
								</div>
							</div>
						</div>
					<?php
