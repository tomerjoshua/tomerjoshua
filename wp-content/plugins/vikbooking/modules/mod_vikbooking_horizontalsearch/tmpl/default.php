...
function vboModHorSearchSendRequest(elem, formId) {
	...
	jQuery.ajax({
		type: "POST",
		url: "<?php echo VikBooking::ajaxUrl(JRoute::rewrite('index.php?option=com_vikbooking&task=submit_inquiry&Itemid=' . $params->get('itemid', 0), false)); ?>",
		data: qstring
	}).done(function(res) {
